...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"FlashPilotNudgelessLaneChange", {PERSISTENT | DEVELOPMENT_ONLY, INT, "0"}},
    {"ExperimentalMode", {PERSISTENT, BOOL}},
    {"ExperimentalModeConfirmed", {PERSISTENT, BOOL}},
    {"FirmwareQueryDone", {CLEAR_ON_MANAGER_START | CLEAR_ON_ONROAD_TRANSITION, BOOL}},
    {"FlashPilotFordHandsFreeCluster", {PERSISTENT, BOOL}},
    {"FlashPilotFordExperimentalModeShortcut", {PERSISTENT, BOOL, "1"}},
    {"FordLowSpeedFactor_ang", {PERSISTENT | DEVELOPMENT_ONLY, FLOAT, "0.98"}},
    {"FordHighSpeedFactor_ang", {PERSISTENT | DEVELOPMENT_ONLY, FLOAT, "0.90"}},
    {"FordHighSpeedDampening_ang", {PERSISTENT | DEVELOPMENT_ONLY, FLOAT, "0.83"}},
    ...
    {"ModelManager_ModelsCache_Chestnut", {PERSISTENT, JSON}},
