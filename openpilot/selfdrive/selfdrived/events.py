...
EVENTS: dict[int, dict[str, Alert | AlertCallbackType]] = {
  ...
  # An independent AOL lateral session can remain active after ordinary Long
  # engagement ends. This is therefore permanent rather than tied to the
  # global state machine's active/disabled alert types.
