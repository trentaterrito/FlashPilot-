...
class Controls:
  ...
  def state_control(self):
    ...
    # FlashPilot: long_plan/radarState feed the vision stop-release guard in
    # LongControl.update() (see longcontrol.py); both are already subscribed/
    # computed above for this same control loop.
