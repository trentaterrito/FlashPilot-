...
if __name__ == "__main__":
  # BluePilot: upstream waits for the Chestnut PCIe link here; this base has no chestnut flash tooling
  if 'USB' in os.getenv('DEV', '') or os.getenv('CHESTNUT'):
    raise RuntimeError("big (USB GPU) model builds are not supported on this base")
  # End BluePilot
