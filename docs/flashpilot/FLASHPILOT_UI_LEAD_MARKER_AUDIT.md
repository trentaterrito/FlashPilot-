...
Branch: `claude/flashpilot-ux-package` (re-confirmed this round -- file and its
test suite unchanged since the original audit, no active Codex branch
touches either). Audit only, as
